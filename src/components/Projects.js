        ...
        <div id="projects-container">
          <div id="tile1" className="project-tile">
            <div className="project-image">
              <img
                src={GoodSportScreenshot2}
                style={{ objectFit: "fit" }}
                alt="GoodSport Screenshot"
              />
            </div>
            <div className="project-text right">
              ...
              <div id="project-description">
                ...
                <p>
                  GoodSport is a sports team schedule management app that will
                  allow users/players to be added to a team and view all events
                  associated with their team, while coaches can add, update and
                  delete events for their teams.
                </p>
              </div>
              ...
              <div id="links">
                <a
                  href="https://goodsport-app.onrender.com"
                  target="_blank"
                  title="GoodSport live on Render"
                  rel="noreferrer"
                >
                  Live Site
                </a>
                <a
                  href="https://github.com/Kmlove/GoodSport-Phase-5-Project"
                  target="_blank"
                  title="GoodSport on GitHub"
                  rel="noreferrer"
                >
                  GitHub
                </a>
              ...
              <p
                ...
                style={{ marginBottom: "0", color: "red", fontSize: ".8rem" }}
              >
                * Deployed on Render, may take 1 - 2 minutes to spin up.
              </p>
            </div>
          </div>
          {/*end tile1 div*/}
          ...
          <div id="tile2" className="project-tile">
            <div className="project-text left" style={{ alignItems: "end" }}>
              ...
              <div id="project-description" style={{ textAlign: "right" }}>
                ...
                <p>
                  FitConnect seamlessly blends fitness logging with a social
                  media twist, where users can share workout insights, post
                  reflections on stored workout routines, and create new
                  shareable workouts for others to engage with and provide
                  feedback on.
                </p>
              </div>
              <div className="made-with">
              ...
              <div id="links">
                ...
                <a
                  ...
                  target="_blank"
                  title="FitConnect live on Render"
                  rel="noreferrer"
                >
                  Live Site
                </a>
                <a
                  href="https://github.com/Kmlove/FitConnect-Phase-4-Project"
                  target="_blank"
                  title="FitConnect on GitHub"
                  rel="noreferrer"
                >
                  GitHub
                </a>
            ...
            <div className="project-image">
              <img
                src={FitConnectScreenshot2}
                style={{ objectFit: "fit" }}
                alt="FitConnect Screenshot"
              />
            </div>
          </div>
          ...
          <div id="tile3" className="project-tile">
            ...
            <div className="project-text right">
              ...
              <div id="project-description">
                ...
                <p>
                  A virtual game store that offers an immersive shopping
                  experience where users can explore, curate and buy their
                  favorite games and sell games with a bit of price negotiation,
                  all through simple commands.
                </p>
              </div>
              <div className="made-with">
                <img className="icon-p" src={pythonIcon} alt="Python Icon" />
